// https://docs.unity3d.com/Packages/com.unity.remote-config@4.0
using System;
using System.Collections.Generic;
using Hey.Services.RemoteConfig.Editor;
...
namespace Unity.RemoteConfigEditor.UIComponents
{
    internal class SettingsJsonModal : EditorWindow
    {
        ...
        {
            var pWindows = parentWindowType == null ? Resources.FindObjectsOfTypeAll<ConfigEditorWindow>() : Resources.FindObjectsOfTypeAll(parentWindowType);
