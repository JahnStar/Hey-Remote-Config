...
```json
    {
        "dependencies": {
            "com.jahnstar.hey-remote-config": "https://github.com/YOUR_USER/hey-remote-config.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at contact@jahnstar.com.
